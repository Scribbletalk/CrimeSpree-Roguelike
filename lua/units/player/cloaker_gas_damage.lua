...
_G.CSR_SafeOverride(PlayerDamage, "damage_fire", "Cloaker Gas", original_damage_fire, function(self, attack_data)
	-- Guard: only modify gas damage during active Crime Spree
