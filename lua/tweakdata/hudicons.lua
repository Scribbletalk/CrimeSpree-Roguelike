...
local bullets_file = mod_path .. "assets/guis/textures/icons/items/evidence_rounds.dds"
...
local the_edge_file = mod_path .. "assets/guis/textures/icons/items/the_edge.dds"
...
local half_a_glass_file = mod_path .. "assets/guis/textures/icons/items/half_a_glass.dds"
local half_a_glass_path = "guis/textures/pd2/crime_spree/csr_half_a_glass"
local cup_of_joe_file = mod_path .. "assets/guis/textures/icons/items/cup_of_joe.dds"
...
local shocking_surprise_file = mod_path .. "assets/guis/textures/icons/modifiers/shocking_surprise.dds"
...
-- Button icons (located in buttons/ folder)
local btn_back_file = mod_path .. "assets/guis/textures/buttons/back.dds"
local btn_back_path = "guis/textures/pd2/crime_spree/csr_btn_back"
local btn_close_file = mod_path .. "assets/guis/textures/buttons/close.dds"
local btn_close_path = "guis/textures/pd2/crime_spree/csr_btn_close"

-- Shop chest icons (located in icons/chest/ folder) — used by gage_services_page
local chest_closed_file = mod_path .. "assets/guis/textures/icons/chest/chest_close.dds"
local chest_closed_path = "guis/textures/pd2/crime_spree/csr_chest_closed"
local chest_open_file = mod_path .. "assets/guis/textures/icons/chest/chest open.dds"
local chest_open_path = "guis/textures/pd2/crime_spree/csr_chest_open"

-- Gage token icon (used by shop counter / reroll button / card prices)
local gage_token_file = mod_path .. "assets/guis/textures/tokens/g_token.dds"
...
local scrap_file = mod_path .. "assets/guis/textures/icons/items/scrap.dds"
...
local frame_file = mod_path .. "assets/guis/textures/frames/csr_frame.dds"
...
if DB and DB.create_entry then
	...
	-- Shop chest icons
	DB:create_entry(Idstring("texture"), Idstring(chest_closed_path), chest_closed_file)
	DB:create_entry(Idstring("texture"), Idstring(chest_open_path), chest_open_file)
