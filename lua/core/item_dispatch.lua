...
-- loaded script path to the item auto-loader so per-item files (lua/items/)
...
-- work (folder scan, hook index, dispatch) lives in extension_api.lua and
...
if _G.CSR and _G.CSR.on_script_loaded then
	...
	-- The CSR shim (extension_api.lua) loads as a POST-hook on lib/entry, but
