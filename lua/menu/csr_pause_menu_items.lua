...
-- MenuCallbackHandler:return_to_csr_lobby_visible (see csr_contract_callbacks.lua)
...
-- (csr_contract_callbacks.lua) and the on_enter_lobby reroute in
-- csr_lobby_routing.lua. This file only WIRES that existing pipeline into
-- the pause menu UI.
--
...
log("[CSR] csr_pause_menu_items.lua loaded")
