-- CSR end-screen routing (part 1 of 2) — companion to stage_endscreen.lua /
-- hud_stage_endscreen.lua. The HUDManager:setup_endscreen_hud override
-- lives in endscreen_hud_wiring.lua (see the split note below).
--
...
-- pre/post hooks is Hooks:OverrideFunction (mirrors briefing_wiring.lua).
...
-- endscreen_hud_wiring.lua, hooked on lib/managers/hudmanagerpd2 (where
-- HUDManager + setup_endscreen_hud are defined — the same proven hook point as
-- briefing_wiring.lua's setup_mission_briefing_hud override).
--
...
-- signal briefing_wiring.lua / mission_lifecycle.lua use, NOT the
